...
%
% test the sumtpom function 
% function retval = test_sumtpom()
%
% Returns 1 if sumtpom.m performs as expected. Returns 0 
...
function retval = test_sumtpom()
  ...
  observed = sumtpom(V, dim);

  if (arrayequals(expected, observed) == 1) 
    printf('sumtpom.m\tokay\n');
    retval = 1;
  else
    printf('sumtpom.m\tnot okay\n');
    retval = 0;
  endif
