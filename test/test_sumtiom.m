...
%
% test the sumtiom function 
% function retval = test_sumtiom()
%
% Returns 1 if sumtiom.m performs as expected. Returns 0 
...
function retval = test_sumtiom()
  ...
  observed = sumtiom(V, dim);

  if (arrayequals(expected, observed) == 1) 
    printf('sumtiom.m\tokay\n');
    retval = 1;
  else
    printf('sumtiom.m\tnot okay\n');
    retval = 0;
  endif
