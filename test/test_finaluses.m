...
%
% test the finaluses function
% function retval = test_finaluses()
%
% Returns 1 if finaluses.m performs as expected. Returns 0 
...
function retval = test_finaluses()
  ...
  observed  = finaluses(Y, dim);

  if (arrayequals(expected, observed) == 1) 
    printf('finaluses.m\tokay\n');
    retval = 1;
  else
    printf('finaluses.m\tnot okay\n');
    retval = 0;
  endif
