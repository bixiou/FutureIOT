...
% function retval = test_removecolumns()
%
% Returns 1 if removecolumns.m performs as expected. Returns 0 
% if the result is not correct.
%
function retval = test_removecolumns()

  V =  [0, 0, 13.5, 6.5, 0, 0, 0; ...
        0, 0, 7.5, 13, 0, 0, 0; ...
        0, 0, 0, 0, 0, 11.5, 6.5; ...
        0, 0, 0, 0, 0, 7, 21.5];
  ...
  expected = [13.5, 6.5, 0, 0; ...
        7.5, 13, 0, 0; ...
        0, 0, 11.5, 6.5; ...
        0, 0, 7, 21.5];

  observed = removecolumns(V,idx);

  if (arrayequals(expected, observed) == 1) 
    printf('removecolumns.m\tokay\n');
    retval = 1;
  else
    printf('removecolumns.m\tnot okay\n');
    retval = 0;
  endif
