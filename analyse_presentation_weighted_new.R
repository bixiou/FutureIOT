...
decrit(t$transferts_inter[t$transferts_inter!=-1], weights=t$weight[t$transferts_inter!=-1])
decrit(t$transferts_inter[t$transferts_inter_info==FALSE & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==FALSE & t$transferts_inter!=-1]) # 5 5 5.9
decrit(t$transferts_inter[t$transferts_inter_info==T & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==T & t$transferts_inter!=-1]) # 1.9 2 2
decrit(t$transferts_inter[t$transferts_inter_info==FALSE & t$transferts_inter_actuel_vu==T & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==FALSE & t$transferts_inter!=-1 & t$transferts_inter_actuel_vu==T]) # 4.9 5 5
decrit(t$transferts_inter[t$transferts_inter_info==T & t$transferts_inter_actuel_vu==T & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==T & t$transferts_inter!=-1 & t$transferts_inter_actuel_vu==T]) # 1.8 2 2
decrit(t$transferts_inter[t$transferts_inter_info==FALSE & t$transferts_inter_actuel_vu==FALSE & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==FALSE & t$transferts_inter!=-1 & t$transferts_inter_actuel_vu==FALSE]) # 5 5 6.9
decrit(t$transferts_inter[t$transferts_inter_info==T & t$transferts_inter_actuel_vu==FALSE & t$transferts_inter!=-1], weights=t$weight[t$transferts_inter_info==T & t$transferts_inter!=-1 & t$transferts_inter_actuel_vu==FALSE]) # 1.5 2 3
decrit(t$transferts_inter[t$variante_transferts_inter=='s' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='i' & t$transferts_inter!=-1]) # 4 4.9 5
decrit(t$transferts_inter[t$variante_transferts_inter=='i' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='i' & t$transferts_inter!=-1]) # 5 6.1 9.9
decrit(t$transferts_inter[t$variante_transferts_inter=='c' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='c' & t$transferts_inter!=-1]) # 5 5.45 9.9
decrit(t$transferts_inter[t$transferts_inter_actuel_vu==T & t$transferts_inter!=-1], weights = t$weight[t$transferts_inter_actuel_vu==T & t$transferts_inter!=-1]) # 2 3 4
decrit(t$transferts_inter[t$transferts_inter_actuel_vu==FALSE & t$transferts_inter!=-1], weights = t$weight[t$transferts_inter_actuel_vu==FALSE & t$transferts_inter!=-1]) # 5 5 5
decrit(t$transferts_inter[t$type_transferts_inter=='e' & t$transferts_inter!=-1], weights = t$weight[t$type_transferts_inter=='e' & t$transferts_inter!=-1]) # 4.9 4.9 5
decrit(t$transferts_inter[t$type_transferts_inter=='l' & t$transferts_inter!=-1], weights = t$weight[t$type_transferts_inter=='l' & t$transferts_inter!=-1]) # 5 5 5
decrit(t$transferts_inter[t$variante_transferts_inter=='s' & t$type_transferts_inter=='e' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='s' & t$transferts_inter!=-1 & t$type_transferts_inter=='e']) # 3.6 4.2 4.9
decrit(t$transferts_inter[t$variante_transferts_inter=='s' & t$type_transferts_inter=='l' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='s' & t$transferts_inter!=-1 & t$type_transferts_inter=='l']) # 4 5 5
decrit(t$transferts_inter[t$variante_transferts_inter=='i' & t$type_transferts_inter=='e' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='i' & t$transferts_inter!=-1 & t$type_transferts_inter=='e']) # 5 8 10
decrit(t$transferts_inter[t$variante_transferts_inter=='i' & t$type_transferts_inter=='l' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='i' & t$transferts_inter!=-1 & t$type_transferts_inter=='l']) # 5 6.8 9.9
decrit(t$transferts_inter[t$variante_transferts_inter=='c' & t$type_transferts_inter=='e' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='c' & t$transferts_inter!=-1 & t$type_transferts_inter=='e']) # 5 6.8 9.9
decrit(t$transferts_inter[t$variante_transferts_inter=='c' & t$type_transferts_inter=='l' & t$transferts_inter!=-1], weights = t$weight[t$variante_transferts_inter=='c' & t$transferts_inter!=-1 & t$type_transferts_inter=='l']) # 5 5 10
...
summary(rq(transferts_inter ~ variante_transferts_inter, data=t, weights = t$weight, subset=(t$transferts_inter!=-1)))
summary(rq(transferts_inter ~ (variante_transferts_inter=='c') + type_transferts_inter*(variante_transferts_inter=='s'), data=t, weights = t$weight, subset=(t$transferts_inter!=-1)))
t$variante_transferts_inter <- relevel(as.factor(t$variante_transferts_inter), ref = "c")
summary(rq(transferts_inter ~ variante_transferts_inter*type_transferts_inter, data=t, weights = t$weight, subset=(t$transferts_inter!=-1)))
...
summary(rq(Transferts_inter ~ cru*(Diplome >= 4 & revenu >= 2000), data=t2, subset=!is.missing(Transferts_inter), weights = t2$weight), se='boot') # se = 'nid
...
CImedian(t$transferts_inter[t$Diplome >= 4 & t$revenu>=2000]) # 4.9 5 5
...
sum(f$weight[f$transferts_inter==f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[!is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$transferts_inter<f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[!is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
# among superior: 59/17/24 > = < cru while 36/13/51 > = < median desired (not driven by lower projection of perception, because results hold when Info=T)
...
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter==f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter<f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter>5-3*f$transferts_inter_info & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter==5-3*f$transferts_inter_info & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter<5-3*f$transferts_inter_info & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter>2 & f$transferts_inter_info==T & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & f$transferts_inter_info==T & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter==2 & f$transferts_inter_info==T & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & f$transferts_inter_info==T & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & !is.na(f$revenu) & f$transferts_inter<2 & f$transferts_inter_info==T & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])/sum(f$weight[f$revenu>=2000 & f$Diplome >= 4 & f$transferts_inter_info==T & !is.na(f$revenu) & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)])
...
# length(which(f$transferts_inter==f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)))/length(which(!is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)))
# length(which(f$transferts_inter<f$transferts_inter_cru & !is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)))/length(which(!is.missing(f$transferts_inter) & !is.missing(f$transferts_inter_cru)))
t_2 <- t_1 <- t[,c("transferts_inter", "transferts_inter_actuel", "transferts_inter_actuel_vu", "transferts_inter_info", "transferts_inter_cru", "revenu", "Diplome", "diplome4", "age", "Age", "sexe", "revdisp", "rev_tot", "gauche_droite", "vague")]
...
summary(lm(pmin(Transferts_inter, 10) ~ cru*(Diplome >= 4 & revenu >= 2000) + transferts_inter_info + transferts_inter_actuel, data=t2, subset=!is.na(Transferts_inter) & t2$revenu >= 2000, weights = t2$weight))
...
summary(rq(transferts_inter ~ transferts_inter_actuel, data=t, weights = t$weight, subset=(t$transferts_inter!=-1 & t$transferts_inter_actuel!=-1)), se = 'nid')
summary(rq(transferts_inter ~ transferts_inter_actuel, data=t, weights = t$weight, subset=(t$transferts_inter!=-1 & t$transferts_inter_actuel!=-1 & t$transferts_inter_info==FALSE)), se='nid')
summary(rq(transferts_inter ~ transferts_inter_actuel*transferts_inter_info, data=t, weights = t$weight, subset=(t$transferts_inter!=-1 & t$transferts_inter_actuel!=-1)), se='nid')
plot(summary(rq(transferts_inter ~ transferts_inter_actuel, data=t, weights = t$weight, subset=(t$transferts_inter!=-1 & t$transferts_inter_actuel!=-1), tau = c(0.17, 0.33, 0.5, 0.67, 0.83))), parm='transferts_inter_actuel')
plot(summary(rq(transferts_inter ~ transferts_inter_actuel, data=t, weights = t$weight, subset=(t$transferts_inter!=-1 & t$transferts_inter_actuel!=-1 & t$transferts_inter_info==FALSE), tau = c(0.17, 0.33, 0.5, 0.67, 0.83))), parm='transferts_inter_actuel')
...
# abline(v=seq(0,5,by=1), lty=3, col="grey")
axis(2, at = seq(0,1,by=0.2), labels=c(0,20,40,60,80,100))
legend("topright", lwd=2, col=c("blue", "orange"), legend = c("Without Info", "With Info"))

before_par <- par()
par(mar=c(5.1, 4.1, 1.1, 2.1))
plot(jitter(t$transferts_inter_actuel[!is.missing(t$transferts_inter_actuel) & !is.na(t$transferts_inter) & t$transferts_inter_info==FALSE], 10), jitter(t$transferts_inter[!is.missing(t$transferts_inter_actuel) & !is.na(t$transferts_inter) & t$transferts_inter_info==FALSE], 10), xlim=c(0,11), ylim=c(0,11), type='p', cex=0.5, pch=19, col='blue', xlab="Belief for current", ylab="Preferred transfer")
lines(jitter(t$transferts_inter_actuel[!is.missing(t$transferts_inter_actuel) & !is.na(t$transferts_inter) & t$transferts_inter_info==T], 10), jitter(t$transferts_inter[!is.missing(t$transferts_inter_actuel) & !is.na(t$transferts_inter) & t$transferts_inter_info==T], 10), type='p', cex=0.5, pch=19, col='orange')
